...
class ProgramPolicyTest extends TestCase
{
    ...
    public function test_owner_admin_can_access(): void
    {
        ...
        $this->assertTrue($policy->view($this->owner, $program));
        $this->assertTrue($policy->update($this->owner, $program));
        $this->assertTrue($policy->setStatus($this->owner, $program));
    }
    ...
    public function test_trainer_can_access_own_resource(): void
    {
        ...
        $this->assertTrue($policy->view($this->trainer, $program));
        $this->assertTrue($policy->update($this->trainer, $program));
        $this->assertTrue($policy->setStatus($this->trainer, $program));
    }
    ...
    public function test_trainer_cannot_access_other_trainer_resource(): void
    {
        ...
        $this->assertFalse($policy->view($this->trainer, $program));
        $this->assertFalse($policy->update($this->trainer, $program));
        $this->assertFalse($policy->setStatus($this->trainer, $program));
    }
